  ...
  <div class="player" v-show="playlist.length">
    <transition name="normal" @enter="enter" @after-enter="afterEnter" @leave="leave" @after-leave="afterLeave">
      <div class="normal-player" v-show="fullScreen" ref="normalPlayer">
        ...
        <div class="middle" ref="middle" @touchstart.prevent="middleTouchStart" @touchmove.prevent="middleTouchMove"
             @touchend="middleTouchEnd">
          <div class="middle-l" ref="middleL">
            <div class="cd-wrapper" ref="cdWrapper">
              <div class="cd" :class="playState? 'play' : 'play pause'">
        ...
        <div class="bottom">
          <div class="progress-wrapper">
            <span class="time time-l">{{format(songCurrentTime)}}</span>
          ...
          <div class="operators">
            <div class="icon i-left">
              <i :class="playModIcon" @click="changeMode"></i>
            </div>
            <div class="icon i-left" :class="disableCls"><i class="icon-prev" @click="prev"></i></div>
            <div class="icon i-center" :class="disableCls"><i :class="playState?'icon-pause': 'icon-play'"
                                                              @click="togglePlay"></i></div>
    ...
    <transition name="mini">
      <div class="mini-player" v-show="!fullScreen" @click="open">
        <div class="icon">
          <img :src="currentSong.image" width="40" height="40" alt="" :class="playState? 'play' : 'play pause'">
        </div>
        <div class="text">
        ...
        <div class="control">
          <progress-circle :radius="radius" :percent="percent">
            <i @click.stop="togglePlay" class="icon-mini" :class="playState?'icon-pause-mini':'icon-play-mini'"></i>
          </progress-circle>
        </div>
    ...
    <audio ref="audio" @play="ready" @error="error" @timeupdate="timeupdate" @ended="end"
...
<style scoped lang="scss">
  ...
  .player {
    ...
    .mini-player {
      ...
      &.mini-enter-active, &.mini-levae-active {
        transition: all 0.4s;
      }
